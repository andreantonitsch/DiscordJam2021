Shader "Unlit/DiffusionReaction2DSimulationTest"
{
    Properties
    {
		...
		_MouseStrength ("Mouse Strength", Float) = 0.04
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float2 frag(v2f i) : SV_Target
            {
				...
				float dA = _DiffusionRatio.x *  (1 - exp(-_MouseStrength * distance(_MousePosition * aspect_ratio_factor, i.uv * aspect_ratio_factor)));
